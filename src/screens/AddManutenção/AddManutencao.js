      ...
      <ScrollView>
        ...
        <View style={styles.scrollview}>
          <View style={styles.loginBox}>
            <Text style={styles.loginText}>Selecionar Aeronave:</Text>
            <View style={styles.select}>
              <PickerSelect
                onValueChange={(value) => console.log(value)}
                items={[{ label: 'Boing-747', value: 'Boing-747' }]}
              />
            </View>
            ...
            />
            <Text style={styles.loginText}>Nome do Grupo de Tarefas:</Text>
            <TextInput style={styles.input} />
            <Text style={styles.loginText}>Checklist Tarefas:</Text>
            <View style={styles.Adicionado}>
              <Text>{`✅ Tarefa 1
              ✅ Tarefa 2
              ✅ Tarefa 3`}</Text>
            ...
            <TouchableOpacity style={styles.btnCadastro}>
              <Text style={styles.btnText}>Salvar Grupo de Tarefas</Text>
            </TouchableOpacity>
            <Text style={styles.loginText}>Grupos Adicionados:</Text>
            <View style={styles.Adicionado}>
              <Text>Aqui aparecerão os Grupos de Tarefas Adicionados</Text>
            </View>
            ...
            >
              <Text style={styles.btnText}>Adicionar Troca de Componentes</Text>
            </TouchableOpacity>
            <View style={styles.Adicionado}>
