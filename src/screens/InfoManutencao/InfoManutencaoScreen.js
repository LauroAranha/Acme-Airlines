      ...
      <ScrollView>
        <View style={styles.scrollview}>
          <View style={styles.loginBox}>
            ...
            <Image style={styles.imagem} source={planeImg} />
            <View
              style={{
                marginTop: '4%',
            ...
            ></TextInput>
            <Text style={styles.loginText}>Horário de Chegada:</Text>
            ...
            <TextInput style={styles.input} placeholder="Alta"></TextInput>
            <Text style={styles.baseText}>Mecanico Responsavel:</Text>
            <TextInput style={styles.input} placeholder="Jair"></TextInput>
            <View
              style={{
                marginTop: '4%',
                borderBottomColor: 'black',
