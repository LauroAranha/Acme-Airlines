      ...
      >
        ...
        >
          <View style={styles.scrollview}>
            <Text style={styles.baseText}>Manutenções Solicitadas:</Text>

            <View style={styles.ListItem}>
              <TouchableOpacity
                onPress={() => navigation.navigate('InfoManuten')}
              >
                <Image style={styles.btnImagem} source={planeImg} />
                <Text style={styles.title}>Boeing 737</Text>
                <Text style={styles.texto}>
                  Horário de chegada: <Text style={styles.hours}>--:--</Text>
                </Text>
                <Text style={styles.texto}>
                  Prioridade: <Text style={styles.textoCorAlta}>Alta</Text>
                </Text>
                ...
                <Text style={styles.texto}>
                  Status: <Text style={styles.textoCorMedia}>A fazer</Text>
                </Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.ListItem}>
              ...
              >
                ...
                <Text style={styles.texto}>
                  Prioridade: <Text style={styles.textoCorMedia}>Média</Text>
                </Text>
                <Text style={styles.texto}>
            ...
            <View style={styles.ListItem}>
              ...
              >
                ...
                <Text style={styles.texto}>Horário de chegada: --:--</Text>
                <Text style={styles.texto}>
                  Prioridade: <Text style={styles.textoCorBaixa}>Baixa</Text>
                </Text>
                <Text style={styles.texto}>
                  Solicitante: Mecânico - Pedro Vieira
                </Text>
                <Text style={styles.texto}>
                  Status: <Text style={styles.textoCorBaixa}>Concluida</Text>
                </Text>
              </TouchableOpacity>
            </View>
            <TouchableOpacity
