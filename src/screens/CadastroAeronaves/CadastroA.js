      ...
      <ScrollView>
        <View style={styles.scrollview}>
          <View style={styles.loginBox}>
            <Text style={styles.loginText}>Imagem da Aeronave:</Text>
            <TouchableOpacity style={styles.btnLogin} onPress={pickImage}>
            ...
            <Text style={styles.loginText}>Horario de Chegada:</Text>
            <TextInputMask
              type={'datetime'}
