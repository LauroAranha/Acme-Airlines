...
// Import React Firebase and Firestore
...
export default function CardAeronave({ props, navigation }) {
        ...
        <View>
          <View style={styles.caixona}>
            <View style={styles.esquerda}>
              ...
              <Text style={styles.textoUltimoVoo}>{props.ultimoVoo}</Text>
            ...
            <View style={styles.botaoCaixona}>
              ...
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('EditarAeronave')}
              >
